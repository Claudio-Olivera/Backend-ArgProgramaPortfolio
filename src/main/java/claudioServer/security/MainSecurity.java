package claudioServer.security;

import claudioServer.jwt.JwtEntryPoint;
import claudioServer.jwt.JwtTokenFilter;
import claudioServer.service.UserDetailsServiceImpl;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                .authorizeRequests()
                .antMatchers("/ver/persona","/ver/educacion","/ver/experiencia","/ver/Hard","/ver/Soft","/ver/Proyectos").permitAll()
